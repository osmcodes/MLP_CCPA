...
Data1= importdata('D:\01. Research\04. Physics A Journal Paper\01.Verion-11_June 2019\Datasets\Dolphins.csv'); %Full Dataset
...
%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%   CN-1   %%%%%%%%%%%%%%%%%%%%%%%%%%%%
tempo1=0;tempo2=0;tempo3=0;tempo4=0;

for iii=1:length(Data1Length)
    for jjj=iii+1:length(Data1Length)   
           tempo1=intersect(neighbors(GData1,iii),neighbors(GData1,jjj));
           tempo2=degree(GData1,tempo1);   
           tempo3=sum(tempo2); 
           tempo4=(1/log(tempo3));
        if tempo1~=0
            CNs(iii,jjj)=tempo4;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Data2= importdata('D:\01. Research\04. Physics A Journal Paper\01.Verion-11_June 2019\Datasets\Dolphins.csv');                  %%Full Dataset
...
Data2Probe= importdata('D:\01. Research\04. Physics A Journal Paper\01.Verion-11_June 2019\Testing & Training_Datasets 80%\Dolphins\DolphinsEP4.csv'); % import EP
%Seperate input Table rows 
 D2ProbeMC1=Data2Probe(:, 1);
 D2ProbeMiC2=Data2Probe(:, 2);
 
 %%% Importing Training-Set ET %%%
Data2Train= importdata('D:\01. Research\04. Physics A Journal Paper\01.Verion-11_June 2019\Testing & Training_Datasets 80%\Dolphins\DolphinsET4.csv'); % import ET
%Seperate input Table rows 
...
for iii=1:length(Data2Uni)
    for jjj=iii+1:length(Data2Uni)   
         %CNData2(iii,jjj)=(degree(GData2,iii))*(degree(GData2,jjj));
           tempo1=intersect(neighbors(GData2,iii),neighbors(GData2,jjj));
           tempo2=degree(GData2,tempo1);   
           tempo3=sum(tempo2); 
           tempo4=(1/log(tempo3));
        if tempo1~=0
            CNData2(iii,jjj)=tempo4;
        end
            tempo1=0;tempo2=0;tempo3=0;tempo4=0;%again reset to zero
    end
end
