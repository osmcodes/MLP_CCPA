...
Data1= importdata('D:\01. Research\04. Physics A Journal Paper\01.Verion-11_June 2019\Datasets\karate.csv'); %Full Dataset
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Data2= importdata('D:\01. Research\04. Physics A Journal Paper\01.Verion-11_June 2019\Datasets\karate.csv');                  %%Full Dataset
...
Data2Probe= importdata('D:\01. Research\04. Physics A Journal Paper\01.Verion-11_June 2019\Testing & Training_Datasets 80%\Karate\KarateEP2.csv'); % import EP
%Seperate input Table rows 
 D2ProbeMC1=Data2Probe(:, 1);
 D2ProbeMiC2=Data2Probe(:, 2);
 
 %%% Importing Training-Set ET %%%
Data2Train= importdata('D:\01. Research\04. Physics A Journal Paper\01.Verion-11_June 2019\Testing & Training_Datasets 80%\Karate\KarateET2.csv'); % import ET
%Seperate input Table rows 
